...
<h1> ## Comandos Básicos GitHub. </h1>

<h2> Tipo de Comandos /  Descrição  </h2> <BR>                                                           

| `git clone`    | Baixar o código-fonte existente de um repositório remoto (como, por exemplo, o Github).  </BR>              
| `git branch`   | Ramificações são altamente importantes no mundo do git.        </BR>                   
| `git checkout:`| Alternar entre as ramificaçõe </BR>     
| `git status`   | Verificar o status do seu repositório. </BR>     
| `git add: `    | Adicionar seus projetos na fila para ser comitado. </BR>     
| `git commit -m "conteudo"`| Informa sobre o que se trata o código criado. </BR>     
| `git push -u origin main`| Envia o código do repositório local para o remoto. </BR>     
</br>
